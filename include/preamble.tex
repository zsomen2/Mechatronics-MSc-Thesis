...
\pagestyle{plain}
\geometry{inner=20mm, outer=20mm, top=20mm, bottom=20mm}
...
\subsectionfont{\Large\itshape\mdseries} % chktex 6
\subsubsectionfont{\large\itshape\mdseries} % chktex 6
...
\lstset{
	...
	tabsize=2,
	literate=*
		{á}{{\'a}}1	{é}{{\'e}}1	{í}{{\'i}}1	{ó}{{\'o}}1	{ö}{{\"o}}1	{ő}{{\H{o}}}1	{ú}{{\'u}}1	{ü}{{\"u}}1	{ű}{{\H{u}}}1 % chktex 7
...
\newcommand{\doi}[1]{DOI: \href{http://dx.doi.org/\detokenize{#1}}{\raggedright{\texttt{\detokenize{#1}}}}} % chktex 13
...
\renewcommand{\captionlabelfont}{\it} % chktex 6
\renewcommand{\captionfont}{\footnotesize\it} % chktex 6
...
%--------------------------------------------------------------------------------------
\newcommand{\excludeFromLoFAndLoT}{%
